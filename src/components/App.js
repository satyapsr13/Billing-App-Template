...
function App() {
  const [name, setName] = useState("Rajkumar Rathour");
  const [address, setAddress] = useState("Jaithari");
  const [email, setEmail] = useState("rajkumar@gmail.com");
  const [phone, setPhone] = useState("+91 9893358081");
  const [bankName, setBankName] = useState("SBI");
  const [bankAccount, setBankAccount] = useState("11111111111");
  const [website, setWebsite] = useState("bhoomitraders.com");
